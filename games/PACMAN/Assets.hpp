...
static const SpriteType PACMAN_MAP[31][28] = {
    ...
    { // Row 4
        WALL_L2, TILE_EMPTY, WALL_L1, TILE_EMPTY,
        TILE_EMPTY, WALL_R1, TILE_EMPTY, WALL_L1,
        TILE_EMPTY, TILE_EMPTY, TILE_EMPTY, WALL_R1,
        TILE_EMPTY, WALL_L1, WALL_R1, TILE_EMPTY,
        WALL_L1, TILE_EMPTY, TILE_EMPTY, TILE_EMPTY,
        WALL_R1, TILE_EMPTY, WALL_L1, TILE_EMPTY,
        TILE_EMPTY, WALL_R1, TILE_EMPTY, WALL_R2
    },
    { // Row 5
    ...
    { // Row 11
        TILE_EMPTY, TILE_EMPTY, TILE_EMPTY, TILE_EMPTY,
        TILE_EMPTY, WALL_L2, TILE_EMPTY, WALL_L1,
    ...
    { // Row 12
        ...
        TILE_EMPTY, TILE_EMPTY, TILE_EMPTY, TILE_EMPTY,
        TILE_EMPTY, TILE_EMPTY, TILE_EMPTY, WALL_L1,
        WALL_R1, TILE_EMPTY, WALL_R2, TILE_EMPTY,
