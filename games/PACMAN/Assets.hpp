...
#define SPRITE_PACMAN_ALL(x, y) IGameModule::Asset({x, y}, "()", {16, 16})
...
#define SPRITE_TURN_QTR         IGameModule::Asset({5, 6}, "==")
#define SPRITE_TURN_QTL         IGameModule::Asset({4, 6}, "==")
#define SPRITE_TURN_QBL         IGameModule::Asset({4, 7}, "==")
#define SPRITE_TURN_QBR         IGameModule::Asset({5, 7}, "==")

#define SPRITE_WALL_QT          IGameModule::Asset({3, 6}, "==")
#define SPRITE_WALL_QB          IGameModule::Asset({2, 7}, "==")
#define SPRITE_WALL_QR          IGameModule::Asset({2, 6}, "||")
#define SPRITE_WALL_QL          IGameModule::Asset({3, 7}, "||")
...
#define SPRITE_TURN_TLB2        IGameModule::Asset({0, 6}, "\\\\")
#define SPRITE_TURN_TBR2        IGameModule::Asset({0, 7}, "//")

#define SPRITE_TURN_LTR2        IGameModule::Asset({7, 8}, "|\\")
#define SPRITE_TURN_LBR2        IGameModule::Asset({7, 9}, "|/")

#define SPRITE_TURN_RTL2        IGameModule::Asset({6, 8}, "/|")
#define SPRITE_TURN_RLB2        IGameModule::Asset({6, 9}, "\\|")
...
static const std::vector<std::vector<IGameModule::Asset>> PACMAN_MAP = {
    { // Row 1
        ...
        SPRITE_WALL_T2, SPRITE_WALL_T2, SPRITE_WALL_T2, SPRITE_WALL_T2,
        SPRITE_WALL_T2, SPRITE_TURN_TLB2, SPRITE_TURN_TBR2, SPRITE_WALL_T2,
        SPRITE_WALL_T2, SPRITE_WALL_T2, SPRITE_WALL_T2, SPRITE_WALL_T2,
        SPRITE_WALL_T2, SPRITE_WALL_T2, SPRITE_WALL_T2, SPRITE_WALL_T2,
    ...
    { // Row 13
        SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY,
        SPRITE_TILE_EMPTY, SPRITE_WALL_L2, SPRITE_TILE_EMPTY, SPRITE_WALL_L1,
        SPRITE_WALL_R1, SPRITE_TILE_EMPTY, SPRITE_TURN_QTL, SPRITE_WALL_QT,
        SPRITE_DOOR_LEFT, SPRITE_DOOR_MID, SPRITE_DOOR_MID, SPRITE_DOOR_RIGHT,
        SPRITE_WALL_QT, SPRITE_TURN_QTR, SPRITE_TILE_EMPTY, SPRITE_WALL_L1,
        SPRITE_WALL_R1, SPRITE_TILE_EMPTY, SPRITE_WALL_R2, SPRITE_TILE_EMPTY,
        SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY
    },
    { // Row 14
        SPRITE_WALL_T2, SPRITE_WALL_T2, SPRITE_WALL_T2, SPRITE_WALL_T2, SPRITE_WALL_T2,
        SPRITE_TURN_SLT1, SPRITE_TILE_EMPTY, SPRITE_TURN_STR1, SPRITE_TURN_SLT1,
        SPRITE_TILE_EMPTY, SPRITE_WALL_QL, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY,
        SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY,
        SPRITE_WALL_QR, SPRITE_TILE_EMPTY, SPRITE_TURN_STR1, SPRITE_TURN_SLT1,
        SPRITE_TILE_EMPTY, SPRITE_TURN_STR1, SPRITE_WALL_T2, SPRITE_WALL_T2,
        SPRITE_WALL_T2, SPRITE_WALL_T2, SPRITE_WALL_T2
    },
    { // Row 15
        SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY,
        SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY,
        SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_WALL_QL, SPRITE_TILE_EMPTY,
        SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY,
        SPRITE_TILE_EMPTY, SPRITE_WALL_QR, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY,
        SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY,
        SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY
    },
    { // Row 16
        SPRITE_WALL_B2, SPRITE_WALL_B2, SPRITE_WALL_B2, SPRITE_WALL_B2, SPRITE_WALL_B2,
        SPRITE_TURN_SLB1, SPRITE_TILE_EMPTY, SPRITE_TURN_SBR1, SPRITE_TURN_SLB1,
        SPRITE_TILE_EMPTY, SPRITE_WALL_QL, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY,
        SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY,
        SPRITE_WALL_QR, SPRITE_TILE_EMPTY, SPRITE_TURN_SBR1, SPRITE_TURN_SLB1,
        SPRITE_TILE_EMPTY, SPRITE_TURN_SBR1, SPRITE_WALL_B2, SPRITE_WALL_B2,
        SPRITE_WALL_B2, SPRITE_WALL_B2, SPRITE_WALL_B2
    },
    { // Row 17
        SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY,
        SPRITE_TILE_EMPTY, SPRITE_WALL_L2, SPRITE_TILE_EMPTY, SPRITE_WALL_L1,
        SPRITE_WALL_R1, SPRITE_TILE_EMPTY, SPRITE_TURN_QBL, SPRITE_WALL_QB,
        SPRITE_WALL_QB, SPRITE_WALL_QB, SPRITE_WALL_QB, SPRITE_WALL_QB,
        SPRITE_WALL_QB, SPRITE_TURN_QBR, SPRITE_TILE_EMPTY, SPRITE_WALL_L1,
        SPRITE_WALL_R1, SPRITE_TILE_EMPTY, SPRITE_WALL_R2, SPRITE_TILE_EMPTY,
        SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY
    },
    { // Row 18
    ...
    { // Row 19
        SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY,
        SPRITE_TILE_EMPTY, SPRITE_WALL_L2, SPRITE_TILE_EMPTY, SPRITE_WALL_L1,
        SPRITE_WALL_R1, SPRITE_TILE_EMPTY, SPRITE_TURN_SBR1, SPRITE_WALL_T1,
        SPRITE_WALL_T1, SPRITE_WALL_T1, SPRITE_WALL_T1, SPRITE_WALL_T1,
        SPRITE_WALL_T1, SPRITE_TURN_SLB1, SPRITE_TILE_EMPTY, SPRITE_WALL_L1,
        SPRITE_WALL_R1, SPRITE_TILE_EMPTY, SPRITE_WALL_R2, SPRITE_TILE_EMPTY,
        SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY
    },
    { // Row 20
        SPRITE_TURN_BR2, SPRITE_WALL_T2, SPRITE_WALL_T2, SPRITE_WALL_T2,
        SPRITE_WALL_T2, SPRITE_TURN_SLT1, SPRITE_TILE_EMPTY, SPRITE_TURN_STR1,
        SPRITE_TURN_SLT1, SPRITE_TILE_EMPTY, SPRITE_TURN_STR1, SPRITE_WALL_B1,
        SPRITE_WALL_B1, SPRITE_TURN_XLB1, SPRITE_TURN_XBR1, SPRITE_WALL_B1,
        SPRITE_WALL_B1, SPRITE_TURN_SLT1, SPRITE_TILE_EMPTY, SPRITE_TURN_STR1,
        SPRITE_TURN_SLT1, SPRITE_TILE_EMPTY, SPRITE_TURN_STR1, SPRITE_WALL_T2,
        SPRITE_WALL_T2, SPRITE_WALL_T2, SPRITE_WALL_T2, SPRITE_TURN_LB2
    },
    { // Row 21
        SPRITE_WALL_L2, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY,
    ...
    { // Row 23
        SPRITE_WALL_L2, SPRITE_TILE_EMPTY, SPRITE_TURN_STR1, SPRITE_WALL_B1,
        SPRITE_TURN_XLB1, SPRITE_WALL_R1, SPRITE_TILE_EMPTY, SPRITE_TURN_STR1,
        SPRITE_WALL_B1, SPRITE_WALL_B1, SPRITE_WALL_B1, SPRITE_TURN_SLT1,
        SPRITE_TILE_EMPTY, SPRITE_TURN_STR1, SPRITE_TURN_SLT1, SPRITE_TILE_EMPTY,
        SPRITE_TURN_STR1, SPRITE_WALL_B1, SPRITE_WALL_B1, SPRITE_WALL_B1,
        SPRITE_TURN_SLT1, SPRITE_TILE_EMPTY, SPRITE_WALL_L1, SPRITE_TURN_XBR1,
        SPRITE_WALL_B1, SPRITE_TURN_SLT1, SPRITE_TILE_EMPTY, SPRITE_WALL_R2
    },
    { // Row 24
        SPRITE_WALL_L2, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY,
        SPRITE_WALL_L1, SPRITE_WALL_R1, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY,
        SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY,
        SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY,
        SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY,
        SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_WALL_L1, SPRITE_WALL_R1,
        SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_WALL_R2
    },
    { // Row 25
        SPRITE_TURN_LTR2, SPRITE_WALL_T1, SPRITE_TURN_SLB1, SPRITE_TILE_EMPTY,
        SPRITE_WALL_L1, SPRITE_WALL_R1, SPRITE_TILE_EMPTY, SPRITE_TURN_SBR1,
        SPRITE_TURN_SLB1, SPRITE_TILE_EMPTY, SPRITE_TURN_SBR1, SPRITE_WALL_T1,
        SPRITE_WALL_T1, SPRITE_WALL_T1, SPRITE_WALL_T1, SPRITE_WALL_T1,
        SPRITE_WALL_T1, SPRITE_TURN_SLB1, SPRITE_TILE_EMPTY, SPRITE_TURN_SBR1,
        SPRITE_TURN_SLB1, SPRITE_TILE_EMPTY, SPRITE_WALL_L1, SPRITE_WALL_R1,
        SPRITE_TILE_EMPTY, SPRITE_TURN_SBR1, SPRITE_WALL_T1, SPRITE_TURN_RTL2
    },
    { // Row 26
        SPRITE_TURN_LBR2, SPRITE_WALL_B1, SPRITE_TURN_SLT1, SPRITE_TILE_EMPTY,
        SPRITE_TURN_STR1, SPRITE_TURN_SLT1, SPRITE_TILE_EMPTY, SPRITE_WALL_L1,
        SPRITE_WALL_R1, SPRITE_TILE_EMPTY, SPRITE_TURN_STR1, SPRITE_WALL_B1,
        SPRITE_WALL_B1, SPRITE_TURN_XLB1, SPRITE_TURN_XBR1, SPRITE_WALL_B1, SPRITE_WALL_B1,
        SPRITE_TURN_SLT1, SPRITE_TILE_EMPTY, SPRITE_WALL_L1, SPRITE_WALL_R1,
        SPRITE_TILE_EMPTY, SPRITE_TURN_STR1, SPRITE_TURN_SLT1, SPRITE_TILE_EMPTY,
        SPRITE_TURN_STR1, SPRITE_WALL_B1, SPRITE_TURN_RLB2
    },
    { // Row 27
        SPRITE_WALL_L2, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY,
        SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_TILE_EMPTY, SPRITE_WALL_L1,
    ...
    { // Row 28
        SPRITE_WALL_L2, SPRITE_TILE_EMPTY, SPRITE_TURN_SBR1, SPRITE_WALL_T1,
        SPRITE_WALL_T1, SPRITE_WALL_T1, SPRITE_WALL_T1, SPRITE_TURN_XLT1,
        SPRITE_TURN_XTR1, SPRITE_WALL_T1, SPRITE_WALL_T1, SPRITE_TURN_SLB1,
        SPRITE_TILE_EMPTY, SPRITE_WALL_L1, SPRITE_WALL_R1, SPRITE_TILE_EMPTY,
        SPRITE_TURN_SBR1, SPRITE_WALL_T1, SPRITE_WALL_T1, SPRITE_TURN_XLT1,
        SPRITE_TURN_XTR1, SPRITE_WALL_T1, SPRITE_WALL_T1, SPRITE_WALL_T1,
        SPRITE_WALL_T1, SPRITE_TURN_SLB1, SPRITE_TILE_EMPTY, SPRITE_WALL_R2
    },
    { // Row 29
        SPRITE_WALL_L2, SPRITE_TILE_EMPTY, SPRITE_TURN_STR1, SPRITE_WALL_B1,
