...
static const std::vector<std::vector<SpriteType>> MAP_01 = {
    ...
    { // colums 3
        ...
        WALL_RIGHT, BORDER_OUT_TR, EMPTY, BORDER_OUT_BR, BORDER_OUT_TR, EMPTY,
    ...
    { // colums 12
        ...
        WALL_TOP, EMPTY, BORDER_OUT_BR, WALL_RIGHT, WALL_RIGHT, WALL_RIGHT,
        BORDER_OUT_TR, EMPTY, BORDER_OUT_BR, WALL_RIGHT, WALL_RIGHT,
        WALL_RIGHT, BORDER_OUT_TR, EMPTY, WALL_BOT
    },
    { // colums 13
    ...
    { // colums 15 = 13
        WALL_TOP, EMPTY, WALL_BOT, WALL_TOP, EMPTY, BORDER_OUT_BR,
        WALL_RIGHT, WALL_RIGHT, WALL_RIGHT, BORDER_OUT_TR, EMPTY,
        BORDER_OUT_BR, BORDER_OUT_TR, EMPTY, WALL_BOT, BORDER_IN_BL,
        WALL_RIGHT, BORDER_IN_TL, WALL_TOP, EMPTY, WALL_BOT, BORDER_IN_BL,
        WALL_RIGHT, BORDER_IN_TL, WALL_TOP, EMPTY, WALL_BOT
    },
    { // colums 16 = 12
        WALL_TOP, EMPTY, BORDER_OUT_BL, BORDER_OUT_TL, EMPTY, BORDER_OUT_BL,
        WALL_LEFT, WALL_LEFT, WALL_LEFT, BORDER_OUT_TL, EMPTY, WALL_BOT,
